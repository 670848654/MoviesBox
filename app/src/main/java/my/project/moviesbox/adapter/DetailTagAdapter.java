...
/**
  ...
  * @版本: 1.0
 */
public class DetailTagAdapter extends BaseQuickAdapter<ClassificationDataBean.Item, BaseViewHolder> {
    public DetailTagAdapter(List<ClassificationDataBean.Item> data) {
        super(R.layout.item_detail_tag_item, data);
    }
