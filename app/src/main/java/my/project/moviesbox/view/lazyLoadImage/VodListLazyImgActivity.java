 ...
 * @version 1.0
 * @description: 注释
 * @date 2025/5/17 22:47
 */
public class VodListLazyImgActivity extends VodListActivity implements LazyLoadImgListener, LazyLoadImgContract.View {
    ...
    public void loadImg() {
        ...
        LogUtil.logInfo("imageUrls", imageUrls.toString());
